...
export default function HomePage() {
  return (
    <main>
      ...
      {/* ── Features ── */}
      <section className="border-t border-white/[0.06] px-8 py-20 bg-[#030303]">
      ...
      {/* ── Footer ── */}
      <footer className="border-t border-white/[0.06] px-8 py-6 text-center text-white/25 text-sm bg-[#030303]">
